...
class FCLayerDetailedMemoryEfficient(Layer):
    ...
    def __init__(self, input_size, output_size):
        ...
        # there is no need to store these in memory for the algorithm
        # but it will make the memory usage more efficient
        # because we will not have to create a new array every time
        self.output = [np.empty(output_size)]
        self.backward_input_error = [np.empty(input_size)]
    ...
    def forward_propagation(self, input_data):
        ...
        for output_index in range(self.output_size):
            ...
            output[output_index] = output_neurone_val
        return self.output
    ...
    def backward_propagation(self, backward_output_error_param, learning_rate):
        ...
        backward_input_error = self.backward_input_error[0]
        ...
        for i in range(len(self.neurones)):
            ...
            backward_input_error[i] = input_neurone_val
        ...
        return self.backward_input_error
